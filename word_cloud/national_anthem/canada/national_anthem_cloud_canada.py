...
# Read the whole text.
text = open(path.join(d, 'national_anthem_canada_english.txt')).read()

# read the mask image
image_base = np.array(Image.open(path.join(d, "canada1.png")))
...
# store to file
#wc.to_file(path.join(d, "canada-cloud.png"))
